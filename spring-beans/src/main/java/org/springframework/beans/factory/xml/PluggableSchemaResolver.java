...
public class PluggableSchemaResolver implements EntityResolver {
	...
	public InputSource resolveEntity(@Nullable String publicId, @Nullable String systemId) throws IOException {
		...
		if (systemId != null) {
			//e.g : key: https://www.springframework.org/schema/beans/spring-beans-2.0.xsd
			//      value: org/springframework/beans/factory/xml/spring-beans.xsd
		...
		if (schemaMappings == null) {
			synchronized (this) {
				...
				if (schemaMappings == null) {
					...
					try {
						// 以 Properties 的方式，读取 schemaMappingsLocation至mappings
						Properties mappings =
